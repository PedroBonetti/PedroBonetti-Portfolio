    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 pt-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2">
        <div className="flex flex-col">
          <label htmlFor="name" className="text-2xl opacity-55 mb-1">
            Nome
          </label>
          <input
            id="name"
        ...
        <div className="flex flex-col">
          <label htmlFor="email" className="text-2xl opacity-55 mb-1">
            E-mail
          </label>
          <input
            id="email"
      ...
      <div className="flex flex-col">
        <label htmlFor="message" className="text-2xl opacity-55 mb-1">
          Mensagem
        </label>
        <textarea
          id="message"
      ...
      <button
        type="submit"
        className="bg-black rounded-full text-white py-3 mt-2 text-lg w-full disabled:opacity-50"
        disabled={loading}
      >
