...
export default function Header({ onClickSobre, onClickContato }: HeaderProps) {
 return (
  <header className="w-fit rounded-full py-4 px-10 flex justify-center shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),_0_4px_6px_-2px_rgba(0,0,0,0.05),_0_-2px_4px_-1px_rgba(0,0,0,0.03)]">
   <nav>
